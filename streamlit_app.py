...
topics = ["AP Spanish 4 MCQ Main Idea", "AP Spanish 4 MCQ Contextual", "AP Physics C", "AP Calculus BC", "AP Physics 1", "AP Physics 2", "SAT Math", "SAT Reading and Writing", "Other"]
